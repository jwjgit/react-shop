...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <instrumentation
        ...
        android:label="Tests for cn.jpush.reactnativejpush.test"
        android:targetPackage="cn.jpush.reactnativejpush.test" />
    <!-- Required 自定义用来收发消息的相关权限 -->
    <permission
        android:name="cn.jpush.reactnativejpush.test.permission.JPUSH_MESSAGE"
        android:protectionLevel="signature" /> <!-- Required 一些系统要求的权限，如访问网络等 -->
    <uses-permission android:name="cn.jpush.reactnativejpush.test.permission.JPUSH_MESSAGE" />
    ...
    <application android:debuggable="true" >
        ...
        <activity
            ...
            <intent-filter>
                ...
                <category android:name="cn.jpush.reactnativejpush.test" />
            </intent-filter>
