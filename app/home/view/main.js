...
import Carouseltop from './component/viewpage'
...
class main extends Component {
    ...
    openUpdate = () => {
        let src = 'http://test.njdexin.cn/#/'
        if (Platform.OS === 'ios') {
            src = 'https://itunes.apple.com/cn/app/%E5%BE%B7%E9%91%AB%E4%BA%91%E5%95%86/id1359014827?mt=8'
        }else{
            src= 'http://a.app.qq.com/o/simple.jsp?pkgname=cn.njdexin.dxshop&from=singlemessage'
        }
                        ...
                        <View style={{ width: 0.85 * width, height: 0.85 * width * 897 / 705, alignItems: 'center' }}>
                            ...
                            <View style={{ width: 0.85 * width, height: 0.85 * width * 897 / 705 * 480 / 897, marginTop: 0.85 * width * 897 / 705 * 330 / 897, padding: 15 }}>
                                <View style={{ width: 0.85 * width - 30, padding: 5, justifyContent: 'flex-end', flexDirection: 'row', }}>
                                    <Text style={{ fontSize: 12, color: '#999999' }}>{'V ' + this.props.update.v}</Text>
                                </View>
                                <Text style={{ fontSize: 14, color: '#666',lineHeight:24 }} selectable={true}>{this.props.update.mes}</Text>
                            </View>
                            ...
                            >
                                <Text style={{ color: 'red', fontSize: 16 }}>立即更新</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </Modal>
