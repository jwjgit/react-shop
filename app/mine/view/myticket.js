    ...
    renderRow = ({ item }) => {
        return (
            <View style={styles.rowView}>
                <Image
                    source={require('../../img/ticketbg1.png')}
                    style={styles.rowBackground}
                />
                <View style={styles.rowTopView}>
                    <Text style={{ fontSize: 16, color: 'white', backgroundColor: '#00000000' }}>补签券</Text>
                    <Text style={{ fontSize: 30, fontWeight: 'bold', color: 'white', backgroundColor: '#00000000' }}>1
                    <Text style={{ fontSize: 12, color: 'white', backgroundColor: '#00000000' }}>   次</Text></Text>
                </View>
                <View style={styles.rowBottomView}>
                    <View style={styles.rowIndexView}>
                        <Image
                            source={require('../../img/ticketheart.png')}
        ...
        return (
            <View style={styles.container}>
                <ScrollPage
                    ...
                    right={require('../../img/guoqi.png')}
                    rightClick={() => this.props.navigator.push({ target: 'Overdue' })}
